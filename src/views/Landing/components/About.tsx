    ...
    <div className="bg-black">
      <Container id="about">
        <section className="bg-black">
          <div className="container  m-auto md:flex px-8 md:px-16 py-16 items-center">
            <div className="md:flex-1/2 space-y-7 text-white">
              ...
              <div className="md:grid grid-cols-2 grid-rows-2 gap-4 py-4 space-y-5 md:space-y-0">
                ...
                <div className="text-center md:text-left">
                  ...
                  <p className="text-sm text-gray-300 font-light">
                    Need guidance in coding or a custom-built web app? Let’s
                    make it happen!
                  </p>
                </div>
              </div>
